...
},{"kaboom":"../node_modules/kaboom/dist/kaboom.mjs","./tiled-kaboom":"tiled-kaboom.ts"}],"WoodTiles.ts":[function(require,module,exports) {
"use strict";
...
},{}],"scene/startScene.ts":[function(require,module,exports) {
"use strict";
...
var WoodTiles_1 = __importDefault(require("../WoodTiles"));

var go = kaboom_1.default.go,
    onKeyDown = kaboom_1.default.onKeyDown,
    add = kaboom_1.default.add,
    loadAseprite = kaboom_1.default.loadAseprite,
    loadTiledMap = kaboom_1.default.loadTiledMap;
var levels = undefined;
var key = undefined;

function createLabel(k, message) {
  add([k.text(message, {
    size: 32
  }), k.pos(k.width() * 0.5, k.height() * 0.5), k.color(255, 1, 1), k.origin('center')]);
}

function StartScene() {
  createLabel(kaboom_1.default, "Press space to start");
  loadTiledMap(WoodTiles_1.default).then(function (r) {
    levels = r.levels;
    key = r.key;
  }); // console.log(levels)
...
},{"../kaboom":"kaboom.ts","../WoodTiles":"WoodTiles.ts"}],"scene/mainScene.ts":[function(require,module,exports) {
"use strict";
...
var add = kaboom_1.default.add,
    ...
    destroyAll = kaboom_1.default.destroyAll;
...
function MainScene(config) {
  ...
  var faune = add([pos(100, 100), sprite("faune"), origin('center'), solid(), body({
    maxVel: 0
  }), area()]);
  faune.play("idle-up");
  var name = add([text("Lunat1k", {
    size: 8
  }), pos(faune.pos)]);
  ...
  faune.action(function () {
    ...
    var infos = kaboom_1.default.get('info');
    var colliding = false;
    ...
    for (var _i = 0, infos_1 = infos; _i < infos_1.length; _i++) {
      ...
      if (faune.isColliding(info)) {
        ...
        if (space) {
          add([text(info.message, {
            size: 16,
            width: 200
          }), pos(info.pos.x - 100, info.pos.y - 50), 'printed-text']);
        }
      }
    }
...
},{"../kaboom":"kaboom.ts"}],"main.ts":[function(require,module,exports) {
"use strict";
